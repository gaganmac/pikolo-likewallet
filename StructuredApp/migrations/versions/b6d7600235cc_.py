...
Revision ID: b6d7600235cc
Revises: 7b469c6bab58
Create Date: 2017-08-02 17:54:18.617946
...
revision = 'b6d7600235cc'
down_revision = '7b469c6bab58'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_column('auth_user', 'campaigns')
...
def downgrade():
    ...
    sa.Column('campaigns', sa.VARCHAR(length=128), autoincrement=False, nullable=True),
